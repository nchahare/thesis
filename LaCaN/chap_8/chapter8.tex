...
In the previous chapter, we discovered that domes subjected to constant pressure gradually inflate and eventually reach a steady state. Employing a computational framework, we deduced that stretching induces viscoelastic stress and active tension in the tissue. To achieve a steady state, cytoskeletal remodeling dissipates viscoelastic stress, and active tension increases to counterbalance the external pressure. Consequently, the epithelial tissue exhibits the characteristics of an active viscoelastic material.

Due to this active viscoelasticity, we observed that in cyclic pressure experiments with rates faster than remodeling timescales, the tissue deflates slower than the pressure decreases. This leads to strain accumulation in subsequent cycles. Based on these findings, we hypothesize that tissue in a steady state, when subjected to deflation at rates faster than remodeling timescales, will result in tissue folding.

The tissue reaches a steady state at strains exceeding 100\%, which corresponds to more than twice the original surface area. Therefore, deflating the tissue at a rate faster than it can dissipate viscoelastic stress makes a significant reduction in tissue area unfeasible. We anticipated that when forced to deflate onto the substrate by application of negative pressure, the excess area of the tissue would be accommodated by the formation of folds through a buckling instability

To test this hypothesis, we used a computational model, which is an effective tool for investigating the mechanical effects of deflation at both tissue and individual cell scales. We subjected digital domes at a steady state with 200 Pa pressure to deflation at a negative pressure of -50 Pa in 6s (faster) and 600s (slower). Simulations showed that slower deflation than remodeling timescales allowed the tissue to deflate completely, without buckling, before reaching negative pressure. However, when the tissue was deflated faster than cortical remodeling, viscoelastic stresses were not dissipated, and the digital dome buckled, producing folds (see Figure \ref{fig_8_1}).

During rapid deflation, when negative pressure is applied to the positively curved dome, tissue tension becomes negative in accordance with Laplace's law. This results in compressive stress in the tissue, causing the dome's uniform curvature to become irregular, which is a hallmark of buckling instability (see Figure \ref{fig_8_1}). This is similar to the buckling of a thin plate subjected to in-plane compression, where compressive stress surpassing a critical threshold result in out-of-plane deformations. In our case, the spherical tissue buckles, resulting in an irregular shape when the compressive stress from rapid deflation exceeds a certain threshold.
...
To experimentally validate the simulation results, we designed experiments considering timescales while inflating and deflating affecting buckling.  The pressure profiles were decided as follows (see Figure \ref{fig_8_2}):
